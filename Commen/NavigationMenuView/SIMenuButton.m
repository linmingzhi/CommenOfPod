...
#define KColor(k_red,k_green,k_blue,k_alpha) [UIColor colorWithRed:k_red/255.0 green:k_green/255.0 blue:k_blue/255.0 alpha:k_alpha]
...
- (id)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        self.title.textColor = KColor(34, 34, 34, 1.0);
